...
- Ответ формируется с цитатами и указанием страницы/раздела (если доступно из документа).
...
## Пример юридического вопроса

Можно задавать длинные вопросы, например:

> Государственный контракт был расторгнут в связи с односторонним отказом Заказчика от его исполнения. Обязан ли заказчик направить в федеральный орган исполнительной власти информацию для включения поставщика в РНП?

Сервис вернет: развернутый ответ + цитату из документа + ссылку на страницу или раздел источника.

Формат ответа приближен к ChatGPT: аналитический текст, затем подтверждающая цитата, затем блок **«Вывод»**.
